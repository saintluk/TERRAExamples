...
std::string FMILogger_plant::_fileNameSimulationLog;
std::string FMILogger_plant::_fileNameSystemLog;

FMILogger_plant::FMILogger_plant(void)
{
...
void FMILogger_plant::initLogger(std::string fileNameSimulationLog, std::string fileNameSystemLog,std::string measurementNames)
{
	// Set the variables
...
void FMILogger_plant::fmiLog(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status, fmi2String category, fmi2String message, ...)
{
...
void FMILogger_plant::saveMeasurementPoint(std::string measurementValues)
{
...
fmi2String FMILogger_plant::enumStatusToString(fmi2Status status)
{
